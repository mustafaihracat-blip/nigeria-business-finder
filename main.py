...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('output/finder.log', mode='a', encoding='utf-8')
    ]
)
...
def main():
    parser = argparse.ArgumentParser(
        description="🇳🇬 Nijerya Firma Bulucu - Google & Yandex tabanlı",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Örnekler:
  python main.py --product "solar panels"
  python main.py --product "cement" --regions "South West" "North West"
  python main.py --product "agricultural equipment" --max-cities 10
  python main.py --list-regions
    ...
    if df.empty:
        print("\n⚠️  Hiç sonuç bulunamadı. Lütfen ürün adını veya bölgeyi kontrol edin.")
        return
